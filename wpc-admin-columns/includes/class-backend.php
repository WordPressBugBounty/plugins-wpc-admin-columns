...
class Wpcac_Backend {
    ...
    function admin_columns() {
        ...
        <div class="wpcac-popup wpcac-popup-columns" id="wpcac-popup-columns"
            ...
            <div class="wpcac-btns" data-screen_key="<?php echo esc_attr( $screen_key ); ?>">
                <button type="button"
                        class="wpcac-add-btn button"><?php esc_html_e( '+ Add column', 'wpc-admin-columns' ); ?></button>
                <a class="wpcac-reset-btn" href="#"><?php esc_html_e( 'reset', 'wpc-admin-columns' ); ?></a>
                <button type="button"
                        class="wpcac-save-btn button button-primary"><?php esc_html_e( 'Save Changes', 'wpc-admin-columns' ); ?></button>
            </div>
        </div>
    ...
    function get_column( $key, $column, $system_columns = [], $screen_key = '' ) {
        ...
        if ( $key !== 'cb' && $key !== 'handle' ) {
            ?>
            <div class="<?php echo esc_attr( 'wpcac-column wpcac-column-' . $type . ' wpcac-column-' . $key . ' ' . ( $is_enable ? 'wpcac-column-enable' : '' ) ); ?>"
                 data-column="<?php echo esc_attr( $key ); ?>">
                <div class="wpcac-column-heading">
                    <span class="move"></span><span class="title"><span
                                class="name"><?php echo esc_html( wp_strip_all_tags( $name ) ); ?></span><span
                                class="type"><?php echo esc_attr( $is_system ? $key : $type ); ?></span></span><span
                            class="enable hint--left"
                            aria-label="<?php echo esc_attr( $is_enable ? esc_attr__( 'Enabled', 'wpc-admin-columns' ) : esc_attr__( 'Disabled', 'wpc-admin-columns' ) ); ?>"><a
                                class="wpcac-enable-btn button <?php echo esc_attr( $is_enable ? 'enabled button-primary' : 'disabled' ); ?>"></a></span>
                </div>
                <div class="wpcac-column-content">
                    <input type="hidden" name="wpcac_columns[<?php echo esc_attr( $key ); ?>][enable]"
                           class="wpcac_column_enable" value="<?php echo esc_attr( $column['enable'] ); ?>"/>
                    <?php if ( ! $is_system ) { ?>
                        <div class="wpcac-column-content-line">
                            ...
                            <div class="wpcac-column-content-value">
                                <input type="text" name="wpcac_columns[<?php echo esc_attr( $key ); ?>][name]"
                                       class="wpcac_column_name" value="<?php echo esc_attr( $name ); ?>"/>
                            </div>
                        </div>
                        <div class="wpcac-column-content-line">
                            <div class="wpcac-column-content-label"><?php esc_html_e( 'Type', 'wpc-admin-columns' ); ?></div>
                            <div class="wpcac-column-content-value">
                                <select name="wpcac_columns[<?php echo esc_attr( $key ); ?>][type]"
                                        class="wpcac_column_type">
                                    <?php
                        ...
                        <div class="wpcac-column-content-line wpcac-hide-if-type-default wpcac-show-if-type-custom_text">
                            ...
                            <div class="wpcac-column-content-value">
                                <textarea
                                        name="wpcac_columns[<?php echo esc_attr( $key ); ?>][text]"><?php echo esc_textarea( $column['text'] ); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="wpcac-column-content-line wpcac-hide-if-type-default wpcac-show-if-type-custom_field wpcac-show-if-type-product_meta wpcac-show-if-type-user_meta wpcac-show-if-type-term_meta">
                            ...
                            <div class="wpcac-column-content-value">
                                <select name="wpcac_columns[<?php echo esc_attr( $key ); ?>][data_type]"
                                        class="wpcac_data_type">
                        ...
                        <div class="wpcac-column-content-line wpcac-hide-if-data-type-default wpcac-show-if-data-type-select wpcac-show-if-data-type-multiple_select">
                            ...
                            <div class="wpcac-column-content-value">
                                ...
                                <textarea
                                        name="wpcac_columns[<?php echo esc_attr( $key ); ?>][choices]"><?php echo esc_textarea( $column['choices'] ); ?></textarea>
                            </div>
                        </div>
                    ...
                    <?php } else { ?>
                        <input type="hidden" name="wpcac_columns[<?php echo esc_attr( $key ); ?>][type]"
                               value="system"/>
                        <input type="hidden" name="wpcac_columns[<?php echo esc_attr( $key ); ?>][name]"
                               value="<?php echo esc_attr( $name ); ?>"/>
                    <?php } ?>
                    <div class="wpcac-column-content-line">
                        <div class="wpcac-column-content-label"><?php esc_html_e( 'Width', 'wpc-admin-columns' ); ?></div>
                        <div class="wpcac-column-content-value">
                            <input type="number" class="small-text float-left" step="1"
                                   name="wpcac_columns[<?php echo esc_attr( $key ); ?>][width]"
                                   value="<?php echo esc_attr( $column['width'] ); ?>"/>
                    ...
                    <div class="wpcac-column-content-line">
                        ...
                        <div class="wpcac-column-content-value">
                            <input type="text" name="wpcac_columns[<?php echo esc_attr( $key ); ?>][text_color]"
                                   value="<?php echo esc_attr( $column['text_color'] ); ?>" class="wpcac-color-picker"/>
                        </div>
                    </div>
                    <?php if ( ! $is_system ) { ?>
                        <div class="wpcac-column-content-line">
                            ...
                            <div class="wpcac-column-content-value">
                                <a href="#"
                                   class="wpcac-remove remove"><?php esc_html_e( 'remove', 'wpc-admin-columns' ); ?></a>
                            </div>
                        </div>
                    <?php } ?>
                </div>
        ...
        return apply_filters( 'wpcac_column_types', [
                ...
                'shop_order' => [
                        ...
                        'options' => [
                                ...
                                'customer_name'   => esc_html__( 'Customer name', 'wpc-admin-columns' ),
                                'customer_email'  => esc_html__( 'Customer email', 'wpc-admin-columns' ),
                                'billing_phone'   => esc_html__( 'Billing phone', 'wpc-admin-columns' ),
                                'billing_email'   => esc_html__( 'Billing email', 'wpc-admin-columns' ),
    ...
    function save_post( $post_id, $post ) {
        if ( ! empty( $post->post_type ) ) {
            delete_transient( 'wpcac_get_' . $post->post_type . '_meta_keys_' . WPCAC_VERSION );
        }
    }

    function update_user() {
        delete_transient( 'wpcac_get_users_meta_keys_' . WPCAC_VERSION );
    }
            ...
            switch ( $column_type ) {
                ...
                case 'customer_name':
                    if ( $order = wc_get_order( $postid ) ) {
                        ...
                        $column_content = $customer->get_display_name();
                    }
                ...
                case 'customer_email':
                    if ( $order = wc_get_order( $postid ) ) {
                        ...
                        $column_content = $customer->get_email();
                    }
                ...
                case 'billing_email':
                    if ( $order = wc_get_order( $postid ) ) {
                        $column_content = $order->get_billing_email();
                    }
        ...
        <div class="wpclever_settings_page wrap">
                ...
                <div class="wpclever_settings_page_header_text">
                    ...
                    <div class="wpclever_settings_page_desc about-text">
                        <p>
                            ...
                            <a href="<?php echo esc_url( WPCAC_CHANGELOG ); ?>"
                               target="_blank"><?php esc_html_e( 'Changelog', 'wpc-admin-columns' ); ?></a> |
                            <a href="<?php echo esc_url( WPCAC_DISCUSSION ); ?>"
                               target="_blank"><?php esc_html_e( 'Discussion', 'wpc-admin-columns' ); ?></a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="wpclever_settings_page_nav">
                <h2 class="nav-tab-wrapper">
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=wpclever-wpcac&tab=settings' ) ); ?>"
                       class="<?php echo esc_attr( $active_tab === 'settings' ? 'nav-tab nav-tab-active' : 'nav-tab' ); ?>">
                        <?php esc_html_e( 'Settings', 'wpc-admin-columns' ); ?>
                    </a>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=wpclever-wpcac&tab=premium' ) ); ?>"
                ...
                <?php } elseif ( $active_tab === 'premium' ) { ?>
                    <div class="wpclever_settings_page_content_text">
                        <p>Get the Premium Version just $29!
                            <a href="https://wpclever.net/downloads/wpc-admin-columns/?utm_source=pro&utm_medium=wpcac&utm_campaign=wporg"
                               target="_blank">https://wpclever.net/downloads/wpc-admin-columns/</a>
                        </p>
    ...
    function get_meta_keys( $screen_key = 'product' ) {
        ...
        WHERE p.post_type = %s ORDER BY pm.meta_key ASC", $screen_key ) );
            ...
            if ( $screen_key === 'shop_order' ) {
                // WooCommerce COT
                $order_meta_keys = $wpdb->get_col( "SELECT DISTINCT meta_key FROM {$wpdb->prefix}wc_orders_meta ORDER BY meta_key ASC" );
                $get_meta_keys   = array_merge( $get_meta_keys, $order_meta_keys );
            }
