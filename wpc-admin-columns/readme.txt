...
- [WPC Backend Product Filter](https://wordpress.org/plugins/wpc-backend-product-filter/)
- [WPC Smart Linked Products](https://wordpress.org/plugins/wpc-smart-linked-products/)
- [WPC Custom Related Products](https://wordpress.org/plugins/wpc-custom-related-products/)
...
= 2.3.2 =
* Fixed: Use select2 instead of selectWoo
...
= 2.1.1 =
* Fixed: Permission checks on editing (Thanks to kr0d from Wordfence!)

= 2.1.0 =
* Fixed: Custom fields for orders in COT mode
